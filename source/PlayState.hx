...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['Muito Noob', 0.2], //From 0% to 19%
		['Noob', 0.4], //From 20% to 39%
		['bro', 0.5], //From 40% to 49%
		['Oh no', 0.6], //From 50% to 59%
		['Hmm', 0.69], //From 60% to 68%
		['Ok', 0.7], //69%
		['Cool', 0.8], //From 70% to 79%
		['Very Cool', 0.9], //From 80% to 89%
		['Give your hands', 1], //From 90% to 99%
		['Fascinado', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
